                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="border rounded p-3 mb-3">
                            ...
                            <span class="<?php echo $submitCheckIn == 0 ? 'in-time' : 'out-time'; ?>">
                                <?php echo $submitCheckIn == 0 ? 'Đang trong giờ checkin' : 'Ngoài giờ checkin'; ?>
                            </span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="border rounded p-3 mb-3">
                            ...
                            <p><strong>Số điện thoại:</strong> {{ $booking->code_check_in }}</p>
...
<style>
    .in-time {
    color: green; /* Màu xanh cho giờ checkin */
}

.out-time {
    color: red; /* Màu đỏ ngoài giờ checkin */
}
</style>
<script>
