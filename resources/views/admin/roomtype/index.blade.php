    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Quản lí loại phòng</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Admin</a></li>
                        <li class="breadcrumb-item active">Quản lí loại phòng</li>
                    </ol>
                </div>
        ...
        <div class="col-xl-12 col-lg-12">
            <div>
                <div class="card">
                            ...
                            <div class="col-sm-auto">
                                <div>
                                    <a href="apps-ecommerce-add-product.html" class="btn btn-success" id="addproduct-btn"><i
                                            class="ri-add-line align-bottom me-1"></i>Thêm loại phòng</a>
                                </div>
                            </div>
                            <div class="col-sm">
                    ...
                    <div class="card-body">
                        <table id="roomTypeTable" class="display">
                            <tbody class="list form-check-all" id="roomTypeBody">
...
@section('js')
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/js/bootstrap-datepicker.min.js"></script>
    <script type="module" src="{{ asset('assets/admin/assets/js/pages/roomtype-list.js') }}"></script>
@endsection
